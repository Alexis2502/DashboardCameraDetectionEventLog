...
public class HelloController {
    ...
    void onshowBtn(ActionEvent event) throws DocumentException {
        // Configuration
    ...
    public void handleResponse(CloseableHttpResponse response,String path) throws DocumentException {
